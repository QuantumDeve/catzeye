(function ($) {
  ...
  $.fn.tkVectorUSAUnemployment = function () {
    ...
    $.getJSON('/public/data/vector-maps/data/us-unemployment.json', function (data) {
  ...
  $.fn.tkVectorFranceElections = function () {
    ...
    $.getJSON('/public/data/vector-maps/data/france-elections.json', function (data) {
      new jvm.Map({
        map: 'fr_merc_en',
        backgroundColor: "#fff",
  ...
  // random colors
  var palette = [ 
    settings.colors.primary[300], 
    settings.colors.primary[500], 
    settings.colors.success[500], 
    settings.colors.gray[300], 
    settings.colors.success[500], 
    settings.colors.success[600] 
  ], colorsMap;
  ...
  $.fn.tkVectorMallMap = function () {
    ...
    this.vectorMap({
      ...
      markers: [ {
        coords: [ 60, 110 ],
        name: 'Escalator 1',
        style: {fill: settings.colors.primary[300], stroke: "#fff"}
      }, {
        coords: [ 260, 95 ],
        name: 'Escalator 2',
        style: {fill: settings.colors.primary[300], stroke: "#fff"}
